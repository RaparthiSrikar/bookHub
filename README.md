In this project let's build a **Book Hub**.

You will demonstrate your skills by creating an app that will fetch data from an internal server using a class component, displaying that data, using **component lifecycle** methods, **routing**, **authentication**, and **authorization**, and adding responsiveness to the website.
